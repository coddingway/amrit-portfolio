...
const PHOTOS = [
  ...
  },
  {
    ...
    gradient:    'linear-gradient(160deg, oklch(0.10 0.07 148) 0%, oklch(0.20 0.11 132) 100%)',
    aspectRatio: '2/3',
  },
  {
    id:          4,
    label:       'Portrait',
    location:    'Kolkata',
    gradient:    'linear-gradient(160deg, oklch(0.16 0.04 30) 0%, oklch(0.28 0.09 18) 100%)',
    aspectRatio: '5/6',
  },
  {
    id:          5,
    label:       'Travel',
    location:    'Canada',
    gradient:    'linear-gradient(160deg, oklch(0.11 0.07 280) 0%, oklch(0.21 0.11 260) 100%)',
    aspectRatio: '4/3',
  },
  {
    id:          6,
    label:       'Night City',
    location:    'Bangalore',
    gradient:    'linear-gradient(160deg, oklch(0.08 0.09 310) 0%, oklch(0.17 0.13 290) 100%)',
    aspectRatio: '3/4',
  },
]
